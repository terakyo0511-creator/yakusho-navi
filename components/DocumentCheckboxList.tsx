      ...
      {documents.map((doc, i) => (
        <li key={i}>
          <button
            ...
            className={`w-full text-left flex items-start gap-3 rounded-lg px-4 py-3 cursor-pointer select-none transition-colors ${
          ...
          >
            ...
            <span>
              ...
              {doc.note && <span className="block text-sm text-gray-600 mt-0.5">{doc.note}</span>}
            </span>
          </button>
        </li>
      ))}
